...
<p align="center">
A cross-platform, console-based turn-based RPG built as a learning project to explore industry-grade C++ organization, OOP, and scalable architecture to demonstrate core game programming fundamentals such as game loop, state machine, turn system, and basic combat logic with bahasa indonesia.
</p>
